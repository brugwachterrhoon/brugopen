...
function render(data){
  ...
  for(const b of data.bridges){
    ...
    article.innerHTML=
      ...
      timingHtml+ 
      '<div class="data-row"><div class="data-box"><div class="data-label">Waterstand</div><div class="water-value">'+escapeHtml(w.value)+'</div><div class="data-unit">'+escapeHtml(w.unit)+'</div><div class="water-datum">'+escapeHtml(w.datum)+'</div><div class="data-detail" title="'+escapeHtml(b.waterLocationName||'')+'">'+escapeHtml(w.detail)+'</div></div><div class="'+windBoxClass+'" title="'+escapeHtml(windTitle)+'"><div class="data-label">Wind</div><div class="wind-value">'+escapeHtml(v.value)+'</div><div class="data-unit">'+escapeHtml(v.unit)+'</div><div class="data-detail" title="'+escapeHtml(b.windLocationName||'')+'">'+escapeHtml(v.detail)+'</div></div><div class="data-box message-box"><div class="message-head"><span class="message-source">'+escapeHtml(l.source)+'</span><span class="live-value">'+escapeHtml(l.value)+'</span></div><div class="restriction-period"><div class="restriction-label">Stremming</div><div class="restriction-value">'+escapeHtml(l.start)+'<span class="restriction-arrow">→</span>'+escapeHtml(l.end)+'</div></div><div class="interim-row"><span class="interim-label">Tussentijdse opening</span><span class="interim-value">'+escapeHtml(l.interim)+'</span></div><div class="live-detail">'+escapeHtml(l.detail)+'</div></div></div>'+
